...
(function () {
  ...
  // Le bouton flottant chevauche les liens du pied de page à l'approche du bas
  // de la page : on le masque dès que le footer entre dans la zone visible.
  (function () {
    const waBtn = document.querySelector('.whatsapp-float');
    const footer = document.querySelector('.site-footer');
    if (!waBtn || !footer || !('IntersectionObserver' in window)) return;
